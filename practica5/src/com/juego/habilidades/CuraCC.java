...
public class CuraCC implements IHabilidad {
    ...
    public CuraCC(String nombre, String descripcion, int poder, int usosMax, String escalado) {
        this.nombre = nombre;
    ...
    public int escaladoPoder(Personaje pj) {
        ...
        switch (escalado) {
            ...
            case "defensa":
                bonus = pj.getDefensa() * 2;
                break;

            case "inteligencia":
                bonus = pj.getInteligencia() * 2.4;
                break;

            case "destreza":
                bonus = pj.getDestreza() * 2.2;
                break;

            case "velocidad":
                bonus = pj.getVelocidad() * 1.8;
                break;
        }
